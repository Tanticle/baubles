...
public final class Registries {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<BaublesInventoryCapability>> ATTACHMENT_BAUBLES = REGISTRY_ATTACHMENTS.register(
            BaublesData.CapabilitiesAttachments.ID_ATTACHMENT_BAUBLES.getPath(),
            () -> AttachmentType.serializable((holder) -> new BaublesInventoryCapability((Player)holder)).copyOnDeath().build());
